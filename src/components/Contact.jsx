...
const Compo5 = () => {
  return (
    <div id='Contact' className=" max-w-screen min-h-screen flex items-center justify-center bg-[linear-gradient(180deg,#FFFFFF_23.36%,#FD746C_100%)] sm:px-28 py-24 xs:px-5 p-2 sm:pl-32 ">
