...
const Compo5 = () => {
  return (
    <div id='Contact' className=" w-screen min-h-screen flex items-center justify-center bg-[linear-gradient(180deg,#FFFFFF_23.36%,#FD746C_100%)] px-32 py-28 pt-32">
      <div className="bg-white shadow-xl w-full max-w-6xl rounded-xl flex flex-col md:flex-row overflow-hidden">
        {/* Left Panel */}
